...
class TestUser(unittest.TestCase):
    ...
    # TODO : Needs to update the test cases to include all user test cases 
        ...
        test_cases = [
            ...
            },
            {
                ...
                'method_name': 'fetch_equipment',  # Method to fetch data for the section (e.g., 'fetch_ammo')
                'mock_response': {
                    'equipment': [
                        {
                            'equipped': 1,
            ...
            },
            {
                ...
                'method_name': 'fetch_notifications',
                'mock_response': {
                    'awards': 2,
                    'competition': 1,
                    'events': 5,
            ...
            },
            {
                ...
                'method_name': 'fetch_stats',      # Method to fetch data for the section
            ...
            },
            {
                ...
                'method_name': 'fetch_public_status',   # Method to fetch data for the section
                'mock_response': {
                    "baned": False,
            ...
            },
            {
                ...
                'method_name': 'fetch_refill_status',   # Method to fetch data for the section
                'mock_response': {
                    "refills": {
            ...
            #     'method_name': 'fetch_last_reports',   # Method to fetch data for the section
            #     'mock_response': {
            #         "reports": [
            #             {
            #                 "id": "12345",
            ...
            # }
            {
                ...
                'method_name': 'fetch_latest_revives',  # Method to fetch data for the section
                'mock_response': {
                    "revives": [
                        {
                            "timestamp": 1691650445,
            ...
            },
            {
                ...
                'method_name': 'fetch_latest_revives_full',  # Method to fetch data for the section
                'mock_response': {
                    "revives": [
                        {
                            "timestamp": 1691650445,
            ...
            },
            {
                ...
                'method_name': 'fetch_skills',  # Method to fetch data for the section
                'mock_response': {
                    "player_id": 3154835,
                    "bootlegging": "1",
                    "burglary": "2",
        ...
        #     'method_name': 'fetch_stocks',  # Method to fetch data for the section
        #     'mock_response': {
        #         "stocks": {
        #             "1": {
        ...
        # }
            {
                ...
                'method_name': 'fetch_current_timestamp',  # Method to fetch data for the section
                'mock_response': {
            ...
            },
            {
                ...
                'method_name': 'fetch_travel_info',  # Method to fetch travel data
                'mock_response': {
                    "travel": {
            ...
            },
            {
                ...
                'method_name': 'fetch_weapon_exp',  # Method to fetch weapon experience data
                'mock_response': {
                    "weaponexp": [
                        {
            ...
            },  
            {
                ...
                'method_name': 'fetch_work_stats',  # Method to fetch work stats
                'mock_response': {
    ...
    def test_fetch_with_no_data(self):
        ...
        sections_to_test = [
            ...
            ('gym', 'fetch_active_gym', None),              # Added Gym section
            ('hof', 'fetch_rankings', {}),              # Added HallOfFame section
            ...
            ('log', 'fetch_logs', {}),              # Added Log section
            ...
            ('personalstats', 'fetch_stats', None),  # Added PersonalStats section
            ...
            ('refills', 'fetch_refill_status', None),      # Added Refills section
            ('reports', 'fetch_last_reports', []),      # Added Reports section
            ('revives', 'fetch_latest_revives', []),      # Added Revives section
